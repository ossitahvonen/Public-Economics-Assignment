...
\begin{tabular}{rrrrrr}
  \hline
 & \begin{tabular}{@{}l@{}} Census tracts without\\ Jewish institutions (A)\\\end{tabular} & SD(A) & \begin{tabular}{@{}l@{}} Census tracts with\\ Jewish institutions (B)\\\end{tabular}& SD(B) & Difference (C)=(A)-(B) \\ 
  \hline

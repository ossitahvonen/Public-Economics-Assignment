...
Similar conlusions can be reached with different regressions, ie. time series and cross-sectional data. This shows that results are robust, because nothing remarkably different arises from these regressions, since the coefficients are almost similar in all cases. 

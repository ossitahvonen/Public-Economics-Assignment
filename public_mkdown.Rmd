...
A) The main question is if the vocational education has monetary returns and how big these returns are, with also consideration on how long these returns last.
